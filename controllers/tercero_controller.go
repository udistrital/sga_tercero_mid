...
func (c *TerceroController) ConsultarDatosAcudiente() {
	defer errorhandler.HandlePanic(&c.Controller)
...
func (c *TerceroController) GuardarDatosAcudiente() {
	defer errorhandler.HandlePanic(&c.Controller)
...
func (c *TerceroController) ActualizarDatosAcudiente() {
	defer errorhandler.HandlePanic(&c.Controller)
...
func (c *TerceroController) ConsultarLocalidades() {
	defer errorhandler.HandlePanic(&c.Controller)
...
func (c *TerceroController) ConsultarInfoAcademicaAspirante() {
	defer errorhandler.HandlePanic(&c.Controller)
...
func (c *TerceroController) CrearLocalidades() {
	defer errorhandler.HandlePanic(&c.Controller)
...
func (c *TerceroController) ActualizarInfoAcademicaAspirante() {
	defer errorhandler.HandlePanic(&c.Controller)
