...
func init() {
    ...
    beego.GlobalControllerRouter["sga_mid_tercero/controllers:TerceroController"] = append(beego.GlobalControllerRouter["sga_mid_tercero/controllers:TerceroController"],
